...
import { PaperFilterDTO, PaperList } from 'src/app/core/models/paper.model';
...
export class PaperComponent implements OnInit {
  initialData: any;
  filter: PaperFilterDTO = new PaperFilterDTO();
  breadcrumb: Breadcrumb[] = [];
  columns: columns;
  papers: ApiResponseModel<PaperList[]>
  constructor(
  ...
  ngOnInit(): void {
    ...
    this.papers = initialData.papers;
    this.addColumns();
  }
