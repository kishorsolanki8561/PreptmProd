...
import { NotesDetails } from 'src/app/core/models/notes.model';
...
@Component({
  ...
  styleUrls: ['./add-update-notes.component.scss']
})
export class AddUpdateNotesComponent implements OnInit {
  ...
  ddls: Ddls;
  lookupData: Ddls;
  notes: NotesDetails = new NotesDetails()
  ...
  constructor(
    ...
    this.notes = initialData?.notes?.data || new NotesDetails();
    this.initiateFrom();
  ...
  initiateFrom() {
    this.form = this._fb.group({
      ...
      categoryId: [null],
      note_Tags: [[]],
      slugUrl: [{ value: null, disabled: !!this.notes.publishedDate }, Validators.required],
      qualificationId: [null],
      description: [null],
      descriptionHindi: [null],
      keywords: [null],
      keywordsHindi: [null],
      note_Subjects: [null, minLengthArr(1)],
    });
  ...
  initiateFormElements() {
    this.formElements = [
      ...
      },
      {
        ...
        label: 'Description',
        placeholder: 'Add full description of this notes',
        class: 'col-span-4',
        type: 'htmlEditor',
      },
      {
      ...
      {
        controlName: 'note_Subjects',
        label: 'Notes',
        type: 'tableForm',
        tableFormConfig: {
          childForm: this.notesForm,
          childFormElements: [
            {
