...
import { AbstractControl, ControlValueAccessor, FormControl, FormGroup, Validators } from '@angular/forms';
import { NumberFormat, radioOption } from 'src/app/core/models/core.model';
...
export class RadioComponent implements ControlValueAccessor, OnInit, DoCheck {
