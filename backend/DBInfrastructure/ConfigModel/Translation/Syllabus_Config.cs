...
{
    public class Syllabus_Config : IEntityTypeConfiguration<Syllabus_MDL>
    {
        public void Configure(EntityTypeBuilder<Syllabus_MDL> builder)
        {
            ...
            builder.HasMany(e => e.Syllabus_Subjects)
                .WithOne(e => e.Syllabus)
                .HasForeignKey(e => e.SyllabusId)
                .OnDelete(DeleteBehavior.Cascade);

            builder.HasMany(e => e.SyllabusTags)
            .WithOne(e => e.Syllabus)
            .HasForeignKey(e => e.SyllabusId)
            .OnDelete(DeleteBehavior.Cascade);
