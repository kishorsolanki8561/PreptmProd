...
{
    public class Note_Config : IEntityTypeConfiguration<Note_MDL>
    {
        public void Configure(EntityTypeBuilder<Note_MDL> builder)
        {
            ...
            builder.HasMany(e => e.Note_Subjects)
         .WithOne(e => e.Notes)
         .HasForeignKey(e => e.NoteId)
         .OnDelete(DeleteBehavior.Cascade);

            builder.HasMany(e => e.Note_Tags)
            .WithOne(e => e.Notes)
            .HasForeignKey(e => e.NoteId)
            .OnDelete(DeleteBehavior.Cascade);
