...
namespace ModelService.Model.Translation.Recruitment
{
    public class RecruitmentResponseDTO 
    {
        ...
        public List<RHowToApplyAndQuickLinkResponseDTO> HowToApplyAndQuickLinkLookup { get; set; } = new List<RHowToApplyAndQuickLinkResponseDTO>();
        public List<FAQResponseDTO> FAQLookup { get; set; } = new List<FAQResponseDTO>();
        public List<int> Tags { get; set; } = new List<int>();
    }


    public class RHowToApplyAndQuickLinkResponseDTO
    {
    ...
    public class RecruitmentJobDesignationResponseDTO
    {
        public int Id { get; set; }
    ...
    public class RecruitmentQualificationResponseDTO
    {
        public int Id { get; set; }
    ...
    public class RecruitmentDocumentResponseDTO
    {
        public int Id { get; set; }
        public string? Path { get; set; }
        public long RecruitmentId { get; set; }
    }
    public class RecruitmentTagsResponseDTO
    {
        public int Id { get; set; }
